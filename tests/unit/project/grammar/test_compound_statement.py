...
import snapcraft
import snapcraft.project.grammar._compound as compound
import snapcraft.project.grammar._on as on
import snapcraft.project.grammar._to as to
from snapcraft.project import grammar
