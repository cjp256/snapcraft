...
from snapcraft.project.grammar_processing import PartGrammarProcessor
from snapcraft.project.grammar_processing import _part_grammar_processor as processor
